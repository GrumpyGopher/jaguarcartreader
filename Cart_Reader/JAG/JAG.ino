...
byte romSize = 0; // 0 = 1MB, 1 = 2MB, 2 = 6MB
...
static const char romItem3[] PROGMEM = "6MB ROM";
...
void sizeMenu() {
#ifdef OLED
  convertPgm(romMenu, 4);
  unsigned char subMenu = menu_box("Select ROM Size", menuChoices, 4, 0);
